    ...
    <section className="auth-section" style={{paddingTop:"50px"}}>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                <h4>Password</h4>
                {!sigUp && <p className="forgot-password" style={{ color: "#007ac6", fontSize: "13px" }}>Forgot Password?</p>}
            </div>
        ...
        <p>
            {sigUp ? "Already have an account?" : "Don't have an account?"}
            <button
            type="button"
            className="handle-switch-btn"
            onClick={handleSwitch}
            >
            {sigUp ? "Log In" : "Sign Up"}
            </button>
        </p>
        </div>
    </section>
